...
const ModalAddFamilyContact = ({
  ...
  useEffect(() => {
    if (visible && data && isEdit) {
      ...
      setAddress(data.contactAddress !== 'No address provided.' ? data.contactAddress : '')
  ...
  return (
    <CustomModal
      ...
      maxHeight={'500px'}
    >
      <div className='z-[99999] !text-gray-800'>
        <div className='flex flex-col gap-[24px] pb-2 mb-4'>
          <div className='group-input flex flex-col items-start relative'>
            ...
            <TextField
              ...
              value={fullName}
              placeholder={t('Enter family contact’s full name')}
              disabled={isLoading}
              onFocus={() => {
      ...
      <div className='group-input flex justify-between relative gap-4 mb-4'>
        <div className='flex flex-col items-start flex-1'>
          <p className='font-[600] text-[14px] leading-[20px] mb-1 text-gray-800'>{t('infoParams.relationship')}</p>
          <CustomSelect
      ...
      <div className='group-input flex flex-col items-start relative'>
        ...
        <TextField
          ...
          value={address}
          placeholder={t('editFamilyInfo.enterAddress')}
          disabled={isLoading}
          maxLength={500}
          onFocus={() => {
...
export default ModalAddFamilyContact
